...
namespace ManhattanProject
{
	...
	void GameScene::ParseMapObject(TiXmlNode* pParent, TileMap* TileMap)
	{
		...
		if(!value.compare("TileObject"))
		{
			...
			LayerToAdd->AddTile(texture, Vector2(Scale, 0), Rotation, Vector2(PositionX,PositionY), Color(R,G,B,A));
		...
		else if(!value.compare("CollisionRectangle"))
		{
			...
			layer->AddCollision(Vector2(PositionX, PositionY), Width, Height, Rotation);
		}
